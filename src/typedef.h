...
/* field offsets */
EXTERN PetscInt MAXSITES, SP_SIZE, SF_SIZE;
EXTERN PetscInt AS_SIZE,   PF_SIZE,   DP_SIZE,   EX_SIZE,   TM_SIZE;
EXTERN PetscInt AS_OFFSET, PF_OFFSET, DP_OFFSET, EX_OFFSET, TM_OFFSET;
